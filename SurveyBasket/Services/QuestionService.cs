...
public class QuestionService(ApplicationDbContext _context) : IQuestionService
{
    ...
    public async Task<Result<QuestionResponse>> AddAsync(int pollId, QuestionRequest request, CancellationToken cancellationToken = default)
    {
        ...
        //Check if the question content sent by user is already to the same question 
        ...
        question.PollId = pollId;           //Assign pollId to question 
    ...
    public async Task<Result> UpdateAsync(int pollId, int id, QuestionRequest request, CancellationToken cancellationToken = default)
    {
        ...
        //Current answers found in DB
        var currentAnswers = question.Answers.Select(x => x.Content).ToList();

        //Add new answers that not exists in DB
